...
public class VentanaEleccion extends JFrame {
    ...
    public VentanaEleccion() {
        ...
        ImageIcon imagen7 = new ImageIcon("Jugar(2).gif");
        JLabel fondo7 = new JLabel(imagen7);
        fondo7.setBounds(320,440,200,80);
       panel3.add(fondo7);
        ...
        botn1.setBounds(125,350, 200,50);
        ...
        botn2.setBounds(260,350, 200,50);
        ...
        botn3.setBounds(475,350, 200,50);
        ...
        botn4.setBounds(650,350, 200,50);
